...
<div style="height: {height}" class="p-4 sm:p-6 md:p-8 flex flex-col gap-4 rounded-lg border border-solid border-violet-900 dark:border-violet-700 text-center cursor-default group hover:border-violet-600 dark:hover:border-violet-400 duration-200 transition-height">
